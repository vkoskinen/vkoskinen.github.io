	...
	var stations = new L.GeoJSON.AJAX("data/fuel.min.geojson", {
		minZoom: 8,
		filter: function(feature, layer) {
	...
	var cafes = new L.GeoJSON.AJAX("data/cafe.min.geojson", {
		minZoom: 8,
		filter: function(feature, layer) {
			return (feature.properties.name)!=null
		},
